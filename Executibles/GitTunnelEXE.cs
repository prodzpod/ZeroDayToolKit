...
namespace ZeroDayToolKit.Executibles
{
    public class GitTunnelEXE : ZeroDayEXE
    {
        ...
        public override void Draw(float t)
        {
            ...
            TextItem.doFontLabel(DrawUtils.correctBounds(Bounds, new Vector2(-1 + (2f / ramCost), -1 + (24f / ramCost))), frames[frame], GuiData.detailfont, (done ? Color.Lime : Color.White) * fade);
        }
    }
}
